...
class DeezerHTTPError(DeezerAPIException):
    """Specialisation wrapping HTTPError from the aiohttp library."""

    def __init__(self, http_exception: aiohttp.web.HTTPError, *args: object) -> None:
    ...
    @classmethod
    def from_http_error(cls, exc: aiohttp.web.HTTPError) -> DeezerHTTPError:
